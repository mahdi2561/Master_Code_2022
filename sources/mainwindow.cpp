    ...
    , ui(new Ui::MainWindow)
{
    ...
    this->setFixedSize(1069,645);

}
void MainWindow ::setE(const quint16& E)
{
    this->E = std::bitset<1>(E);
}
void MainWindow ::setDR(const quint16& DR)
{
    this->DR = std::bitset<16>(DR);
}
void MainWindow ::setAC(const quint16& AC)
{
    this->AC = std::bitset<16>(AC);
}
void MainWindow ::setIR(const quint16& IR)
{
    this->IR = std::bitset<16>(IR);
}
void MainWindow ::setTR(const quint16& TR)
{
    this->TR = std::bitset<16>(TR);
}
void MainWindow ::setAR(const quint16& AR)
{
    this->AR = std::bitset<12>(AR);
}
void MainWindow ::setPC(const quint16& PC)
{
    this->PC = std::bitset<12>(PC);
}
void MainWindow ::setINPR(const quint8& INPR)
{
    this->INPR = std::bitset<8>(INPR);
}
void MainWindow ::setOUTR(const quint8& OUTR)
{
    this->OUTR = std::bitset<8>(OUTR);
}
void MainWindow ::inrAR()
{
    setAR(getAR() + 1);
}
void MainWindow ::inrPC()
{
    setPC(getPC() + 1);
}
void MainWindow ::inrDR()
{
    setDR(getDR() + 1);
}
void MainWindow ::inrAC()
{
    setAC(getAC() + 1);
}
void MainWindow ::inrTR()
{
    setTR(getTR() + 1);
}
void MainWindow ::clrAR()
{
    AR.reset();
}
void MainWindow ::clrPC()
{
    PC.reset();
}
void MainWindow ::clrDR()
{
    DR.reset();
}
void MainWindow ::clrAC()
{ AC.reset();
}
void MainWindow ::clrTR()
{ TR.reset();
}
void MainWindow ::logicUnitAND()
{
    AC = AC & DR;
}
void MainWindow ::logicUnitCMA()
{
    AC = ~AC;
}
void MainWindow ::logicUnitCME()
{
   E = ~E;
}
quint16 MainWindow ::getE()
{
   return E.to_ulong();
}
quint16 MainWindow ::getDR()
{
   return DR.to_ulong();
}
quint16 MainWindow ::getAC()
{
   return AC.to_ulong();
}
bool MainWindow ::getACleadingBit()
{
   return AC[15];
}
quint16 MainWindow ::getIR()
{
   return IR.to_ulong();
}
quint16 MainWindow ::getTR()
{
   return TR.to_ulong();
}
quint16 MainWindow ::getAR()
{
   return AR.to_ulong();
}
quint16 MainWindow ::getPC()
{
   return PC.to_ulong();
}
quint16 MainWindow ::getINPR()
{
   return INPR.to_ulong();
}
quint16 MainWindow ::getOUTR()
{
   return OUTR.to_ulong();
}
...
{
    QMessageBox::StandardButton resBtn = QMessageBox::question( this,"Master Code 2022",
                                                                tr("Do you want to Clear this Code?\n"),
...
void MainWindow::on_run_btn_clicked()
{
   ...
   // this->setStyleSheet("border-image:url(:/pic/play-60.png);");
}
